    ...
    public class BotNormal : Bot
    {
        ...
        public override void AssignTask(BotTask t)
        {
            ...
            switch (t.Type)
            {
                ...
                case BotTaskType.ParkPod:
                    ...
                    storePodTask.Pod.Waypoint.Y = storePodTask.Pod.Waypoint.AisleWaypointY;
                ...
                case BotTaskType.RepositionPod:
                    ...
                    repositionPodTask.Pod.Waypoint.Y = repositionPodTask.Pod.Waypoint.AisleWaypointY;
                ...
                case BotTaskType.Insert:
                    ...
                    double InsertPodOrientation = storeTask.ReservedPod.Waypoint.PodPickingOrientation;
                    storeTask.ReservedPod.Waypoint = Instance.GetWaypointByID(storeTask.ReservedPod.Waypoint.AisleID);
                    storeTask.ReservedPod.Waypoint.Orientation = InsertPodOrientation;
                ...
                case BotTaskType.Extract:
                    ...
                    double ExtractPodOrientation = extractTask.ReservedPod.Waypoint.PodPickingOrientation;
                    extractTask.ReservedPod.Waypoint = Instance.GetWaypointByID(extractTask.ReservedPod.Waypoint.AisleID);
                    extractTask.ReservedPod.Waypoint.Orientation = ExtractPodOrientation;
        ...
        internal class BotMove : IBotState
        {
            ...
            public void Act(Bot self, double lastTime, double currentTime)
            {
                ...
                //Update orientation of bot as per destination orientation
                if((bot.CurrentWaypoint == bot.DestinationWaypoint) && (bot.DestinationWaypoint.Orientation > 0) &&
                    (bot.Orientation != bot.DestinationWaypoint.Orientation))
                {
                    bot._startOrientation = bot.Orientation;
                    bot._endOrientation = bot.DestinationWaypoint.Orientation;
                    bot._rotateDuration = bot.Physics.getTimeNeededToTurn(bot._startOrientation, bot._endOrientation);
                    bot.NextWaypoint = bot.DestinationWaypoint;
