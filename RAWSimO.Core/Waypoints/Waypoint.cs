...
namespace RAWSimO.Core.Waypoints
{
    ...
    public class Waypoint : Circle, IWaypointInfo, IExposeVolatileID
    {
        ...
        /// <summary>
        /// Stored additional aisle waypoint
        /// </summary>
        public double AisleWaypointY;

        /// <summary>
        /// Stored additional aisle waypoint ID
        /// </summary>
        public int AisleID;

        /// <summary>
        /// Stored pod picking orientation
        /// </summary>
        public double PodPickingOrientation;
